import React, { useEffect, useLayoutEffect, useMemo, useRef, useState, RefObject, MouseEvent } from 'react';
...
const Masonry = ({
  ...
  const handleMouseEnter = (e: MouseEvent<HTMLDivElement>, item: (typeof grid)[0]) => {
  ...
  const handleMouseLeave = (e: MouseEvent<HTMLDivElement>, item: (typeof grid)[0]) => {
    const element = e.currentTarget;
    const selector = `[data-key="${item.id}"]`;
